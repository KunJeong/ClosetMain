...
//   }
// };
//     // const creds = Realm.Sync.Credentials.custom('Admin', 'admin', null);
//     Realm.Sync.User.current.then((user)=>{
//     const config = user.createConfiguration({
//         sync: {url: 'realms://fashion.us1.cloud.realm.io/hello', user: Realm.Sync.User.current},
...
//           // let subscribe = carOwners.subscribe({name: 'my-subscription', 
